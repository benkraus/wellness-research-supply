...
export const Footer = () => {
  ...
  return (
    <footer className="bg-highlight-50 border-t border-primary-900/10 py-8 sm:py-10 text-primary-50">
      <Container>
        <div className="grid w-full gap-6 sm:gap-10 sm:grid-cols-2 lg:grid-cols-6">
          <div className="flex w-full flex-col items-start gap-6 sm:col-span-2 lg:col-span-3">
            <div className="flex flex-col gap-5">
              <div className="h-7 sm:h-8 w-fit">
                <LogoStoreName theme="dark" className="h-full !justify-start" />
              </div>
              <h4 className="text-base sm:text-lg font-bold">Research-Grade Peptides</h4>
        ...
        <div className="mt-6 sm:mt-8 text-xs text-primary-100 leading-relaxed">
